...
<center>
<img src= "img/TAS_linkage_average.png" width = 50%>
</center>
...
<!-- shinyAppDir("shiny_apps/region_summary/", options = list(width = "100%", height = 700)) -->
<!-- ``` -->
...
<!-- * Conditionally simulate observations based the max-stable field for the numerical model output -->
<!-- <br> -->

<!-- * Use these simulations to generate an ensemble and a probabilistic forecast of a spatial field -->
...
<img src= "img/smith_SWWA_high.jpg" width = 49%>
</center>

## Tasmania

<center>
<img src= "img/smith_TAS_low.jpg" width = 49%>
<img src= "img/smith_TAS_high.jpg" width = 49%>
</center>
...
* Helped us understand were we can reasonably assume
