...
<center>
<img src= "kate_img/unconditional_sims/Fig_UncondSim_10.jpeg" width = 24%>
<img src= "kate_img/unconditional_sims/Fig_UncondSim_7.jpeg" width = 24%>
<img src= "kate_img/unconditional_sims/Fig_UncondSim_8.jpeg" width = 24%>
<img src= "kate_img/unconditional_sims/Fig_UncondSim_9.jpeg" width = 24%>
<img src= "kate_img/unconditional_sims/Fig_UncondSim_1.jpeg" width = 24%>
<img src= "kate_img/unconditional_sims/Fig_UncondSim_3.jpeg" width = 24%>
...
<!-- <font color="2292B5"> -->
<!-- **What is the probability that the maximum rainfall in a given radius exceeds some threshold?** -->
<!-- </font> -->
...
<!-- Introduction finite dimensional distributions -->

<!-- * 5.25 -->
<!-- * exponent measure 5.26 (? index on the Y) -->
<!-- * homonegeity property 5.27 / 5.28 -->
<!-- * extremal coefficient 5.29 -->
<!-- * 5.31  -->
...
<!-- ## Density -->
<!-- Assuming unit Fréchet margins, where <font color="2292B5">$\mathbb{P}(Z(x_i) \leq z_i)$</font> then joint distribution at a finite set of sites <font color="2292B5">$x_i$</font> where <font color="2292B5">$i = 1 \dots k$</font> then  -->
<!-- <font color="2292B5"> -->
<!-- $$\mathbb{P}(Z(x_1) \leq z_1, \dots, Z(x_k) \leq z_k) = \exp\{ V(z_1, \dots ,z_k)\} $$ -->
<!-- </font> -->

<!-- where  -->
<!-- <font color="2292B5"> -->
<!-- $$V(z_1, \dots ,z_k) = \mathbb{E} \left[ \max \left\lbrace \frac{Y(x_1)}{z_1}, \dots, \frac{Y(x_k)}{z_k} \right\rbrace \right] $$ -->
<!-- </font> -->

<!-- ## Events in hindsight -->

<!-- <center> -->
<!-- <img src= "kate_img/Fig_CondEgPlot.jpeg" width = 55%> -->
<!-- </center> -->

<!-- <font color="2292B5"> -->
<!-- **Conditional on extreme rainfall occurring, was the rainfall at nearby locations also extreme?** -->
<!-- </font> -->
...
<!-- **What is the probability of maximum rainfall (or total rainfall) in a given radius exceeding some threshold?** -->

<!-- </br> -->
<!-- </br> -->
<!-- </br> -->

<!-- **Conditional on an extreme rainfall event at one location, what is the probability that a nearby location is also affected?** -->
...
<center>
<img src= "kate_img/hclust_vs_kmedoids.png" width = 80%>
...
* Regionalisation helps us understand were we can reasonably assume
