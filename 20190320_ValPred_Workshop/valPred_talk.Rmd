...
where <font color="2292B5">$\mathcal{X} \in \mathbb{R}$</font>, <font color="2292B5"> $W(\cdot, 0, \Sigma)$</font> is the bivaraite Gaussian density, with mean zero and covariance matrix <font color="2292B5">$\Sigma$</font> and 
...
## Smith Process (Canonical Example)
...
<center>
<img src= "talk_img/unconditional_sims/Fig_UncondSim_10.jpeg" width = 24%>
<img src= "talk_img/unconditional_sims/Fig_UncondSim_7.jpeg" width = 24%>
<img src= "talk_img/unconditional_sims/Fig_UncondSim_8.jpeg" width = 24%>
<img src= "talk_img/unconditional_sims/Fig_UncondSim_9.jpeg" width = 24%>
<img src= "talk_img/unconditional_sims/Fig_UncondSim_1.jpeg" width = 24%>
<img src= "talk_img/unconditional_sims/Fig_UncondSim_3.jpeg" width = 24%>
<img src= "talk_img/unconditional_sims/Fig_UncondSim_4.jpeg" width = 24%>
<img src= "talk_img/unconditional_sims/Fig_UncondSim_5.jpeg" width = 24%>
<!-- <img src= "kate_img/unconditional_sims/Fig_UncondSim_6.jpeg" width = 24%> -->
<!-- <img src= "img/unconditional_sims/legend.png" width = 30%> <br> -->
<br />
<center>
<img src= "talk_img/unconditional_sims/legend.png" width = 30% align = "right">
</center>
...
<font color="2292B5">**Perfect Prog Approach:**</font>  
Conditionally simulate an ensemble from the fitted max-stable process
<br>

<font color="2292B5">**Assumptions:**</font>   
The fitted statistical model is the truth  
<br>

<font color="2292B5">**Relevance:**</font>   
...
* Used the regionalisation to inform fitting of max-stable models
